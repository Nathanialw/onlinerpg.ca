...
namespace Equipment {
  ...
  std::string Pick_Up_Item(std::array<std::array<int, 16>, 4> &inventory, std::array<uint8_t , 15>  &equipment, uint8_t index) {
    ...
    auto slot = Get_Equip_Slot(); //retrieve slot using itemID from the db
