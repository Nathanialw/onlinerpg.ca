...
// const websocket = new WebSocket(`wss://onlinerpg.ca/ws:9002?session_id=${sessionId}`);
let websocket = new WebSocket("wss://www.onlinerpg.ca/ws:9002?session_id=${sessionId}");
